...
select opt in "${options[@]}"; do
	...
	"Bypass on Recovery")
        ...
        echo -e "${BLU}Press Enter to move to the next step, which may not fill will automatically get the default value"
  		echo -e "Enter a username (Default: MAC)"
		read realName
  		realName="${realName:=MAC}"
    	echo -e "${BLUE}Get username ${RED}INSTANT WRITING Without Accents ${GRN} (Default: MAC)"
      	read username
